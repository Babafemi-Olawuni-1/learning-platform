...
import { FaRocket, FaTwitter, FaInstagram, FaYoutube, FaArrowRight } from 'react-icons/fa'

const footerLinks = {
  Product: ['Features', 'Pricing', 'Tutors', 'How it works'],
  Exams: ['Cambridge A-Level', 'JAMB UTME', 'WAEC', 'SAT Prep'],
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8 pb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-10 mb-12">
          ...
          <div>
            <a href="#" className="flex items-center gap-2 group mb-4">
              ...
              <span className="text-xl font-700 tracking-tight">
                Ayene<span className="text-[#FF6B6B]">Learn</span>
              </span>
            </a>
            <p className="text-white/55 text-sm font-400 leading-relaxed max-w-xs mb-6">
              Adaptive exam prep for Cambridge, JAMB, and beyond. Built to make studying actually work.
            </p>
            {/* Newsletter mini */}
              ...
              <ul className="space-y-2.5">
                {items.map((item) => (
                  <li key={item}>
                    <a
                      href="#"
                      className="text-white/50 text-sm font-400 hover:text-white hover:text-[#FFD93D] transition-colors duration-200"
                    >
                      {item}
                    </a>
                  </li>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-xs font-400 text-center md:text-left">
            &copy; {new Date().getFullYear()} AyeneLearn. All rights reserved. Built with love for students worldwide.
          </p>
