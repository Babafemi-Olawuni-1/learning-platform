...
function QuizMockup() {
  return (
    ...
    >
      ...
      {/* Question */}
      <p className="text-sm font-600 text-[#2D4059] mb-4 leading-relaxed">
        Solve for x: 3x&sup2; + 5x - 2 = 0
      </p>
      ...
      {[
        ...
        <div
          key={opt.label}
          className={`flex items-center gap-3 p-3 rounded-xl mb-2 text-sm font-500 cursor-pointer transition-all duration-200 ${
            opt.correct
              ? 'bg-[#6BCB77]/20 border-2 border-[#6BCB77] text-[#2D9442]'
              : 'bg-[#2D4059]/5 border-2 border-transparent text-[#2D4059] hover:border-[#FF6B6B]/40'
          }`}
        >
          <span className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-700 ${
            opt.correct ? 'bg-[#6BCB77] text-white' : 'bg-[#2D4059]/10 text-[#2D4059]'
          }`}>{opt.label}</span>
          {opt.text}
      ...
      <div className="flex items-center justify-between mt-4 pt-4 border-t border-[#2D4059]/10">
        <div className="flex items-center gap-1.5 text-xs text-[#2D4059]/60">
          <FaChartLine size={12} />
          <span>Accuracy: 82%</span>
        </div>
        <div className="flex items-center gap-1.5 text-xs text-[#FF6B6B] font-600">
          <FaBolt size={11} />
          <span>Streak x3</span>
        </div>
      </div>
    ...
    <section className="relative min-h-screen flex items-center overflow-hidden pt-24 pb-16">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid md:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
        ...
        <div>
          ...
          >
            <FaStar size={11} />
            20 free questions per subject — no card needed
          </motion.div>
          ...
          >
            Learn smart,{' '}
            <span className="gradient-text">level up faster</span>
          </motion.h1>
          ...
          >
            Adaptive quizzes · auto-graded · track your progress.
            Cambridge &amp; JAMB prep, built for you.
          </motion.p>
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              className="btn-gradient text-white font-600 px-7 py-3.5 rounded-full shadow-lg flex items-center gap-2"
            >
              Try free quiz
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.97 }}
              className="btn-outline text-[#2D4059] font-600 px-7 py-3.5 rounded-full flex items-center gap-2"
            >
          ...
          >
            ...
            <div>
              <div className="flex gap-0.5 mb-0.5">
                {[...Array(5)].map((_, i) => <FaStar key={i} size={12} className="star-filled" />)}
              </div>
              <p className="text-xs text-[#2D4059]/60 font-400">
                Loved by <span className="font-600 text-[#2D4059]">12,000+</span> students
              </p>
            </div>
          </motion.div>
        </div>

        {/* Right: Quiz mockup + floating widgets */}
        <div className="relative flex justify-center">
          <QuizMockup />

          {/* Weather / time floating card */}
          <motion.div
          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center gap-1 text-[#2D4059]/60 mt-0.5">
                <FaClock size={10} />
                <span>7:55 AM · 6/30/2026</span>
              </div>
            </div>
          </motion.div>

          {/* Score pill floating card */}
          <motion.div
          ...
          >
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-[#6BCB77]/20 flex items-center justify-center">
                <FaChartLine size={14} className="text-[#6BCB77]" />
              </div>
              <div>
                <p className="text-xs font-700 text-[#2D4059]">Score improved</p>
                <p className="text-lg font-700 text-[#6BCB77]">+24%</p>
              </div>
            </div>
          </motion.div>
